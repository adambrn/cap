    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogs.equipmentcategory', verbose_name='Категория')),
                ('equipment_status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogs.equipmentstatus', verbose_name='Статус')),
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalogs.manufacturer', verbose_name='Производитель')),
            ],
            options={
