    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Дата возврата')),
                ('computer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.computer', verbose_name='Компьютер')),
                ('power_supply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='components.powersupply', verbose_name='Блок питания')),
            ],
            options={
                'verbose_name': 'История компонента',
                'verbose_name_plural': 'История компонентов',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogs.employee', verbose_name='Сотрудник')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogs.location', verbose_name='Местоположение')),
                ('other_equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.otherequipment', verbose_name='Другое оборудование')),
            ],
            options={
                'verbose_name': 'История оборудования',
                'verbose_name_plural': 'История оборудования',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Дата возврата')),
                ('computer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.computer', verbose_name='Компьютер')),
                ('other_component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='components.othercomponent', verbose_name='Другие компоненты')),
            ],
            options={
                'verbose_name': 'История компонента',
                'verbose_name_plural': 'История компонентов',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogs.employee', verbose_name='Сотрудник')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogs.location', verbose_name='Местоположение')),
                ('network_device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.networkdevice', verbose_name='Сетевое оборудование')),
            ],
            options={
                'verbose_name': 'История оборудования',
                'verbose_name_plural': 'История оборудования',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Дата возврата')),
                ('computer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.computer', verbose_name='Компьютер')),
                ('network_card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='components.networkcard', verbose_name='Сетевая карта')),
            ],
            options={
                'verbose_name': 'История компонента',
                'verbose_name_plural': 'История компонентов',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Дата возврата')),
                ('computer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipments.computer', verbose_name='Компьютер')),
                ('graphics_card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='components.graphicscard', verbose_name='Видеокарта')),
            ],
            options={
                'verbose_name': 'История компонента',
                'verbose_name_plural': 'История компонентов',
